...
<body>
  <main class="main" id="main">
       ...
       <div class="row justify-content-center">
        <div class="col-7">
    <form id="signupForm" class="sign-bor" action="php/seller_signup_submit.php" method="POST" enctype="multipart/form-data">
                            <div class="center">
    <img src="assets/img/dashboard/Wsymbol_black_RT.svg" height="100px" width="auto" alt="Centered Image">
</div>
        <h2 class="text-center pb-4">Seller Sign-Up</h2>
...
<div class="col-md-6 col-sm-6 col-6">
    <div class="form-group">
        ...
        <div class="row">
           ...
           <div class="col-md-12 d-flex align-items-center">
                ...
                <p class="mb-0 ">I have read and accepted <a href="https://docs.google.com/document/d/1yPWgBks9AQax2hioe6ROE3M-l0ishh6aC2cuZcu5M2I/edit?usp=sharing">Terms Of Use </a>and <a href="https://docs.google.com/document/d/11smk-WhUNR-y8EHT4DkuH20yY2nsn7Fqs_56k3RHn_c/edit?usp=sharing">Seller Policy</a> </p>
            </div>
        <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-8 col-sm-12 col-6 pt-1">
                <a href="buyer_signup.php"><p><b>Signup as Buyer</b></p></a>
            </div>
        </div>
    </form>
</div>
    ...
    document.getElementById('signupForm').addEventListener('submit', function(event) {
        ...
        if (age < 16) {
            event.preventDefault();
            document.getElementById('birthdateError').textContent = "You must be 16 or older to sign up";
        } else {
